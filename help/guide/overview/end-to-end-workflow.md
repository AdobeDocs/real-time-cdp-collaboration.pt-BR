...
Depois de estabelecer suas contas, a [!UICONTROL Luma] e o [!UICONTROL DataM8] devem [criar uma conexão de dados e públicos-alvo de origem](../setup/onboard-audiences.md). Ambos os colaboradores podem ativar públicos para campanhas de marketing, portanto, cada um deles precisa [configurar um destino](../destinations/manage-destinations.md).
