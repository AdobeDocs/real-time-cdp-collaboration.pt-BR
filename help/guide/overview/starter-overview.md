...
| Activation | Como usuário do [!DNL Starter], você pode ativar e compartilhar públicos somente com o parceiro que convidou você. Configuration of destinations to external platforms is not available. Learn more about [activating your audiences](../collaborate/activate.md). |

{style="table-layout:auto"}

## Introdução {#getting-started}

After you [accept your invitation and agree to the terms](../connect/establishing-connections.md#accept-invitation-sign-terms), log in to [Adobe Experience Cloud](https://experience.adobe.com/){target="_blank"} with your credentials. Antes de usar o Collaboration, sua conta deve receber o acesso e as funções apropriadas.
...
First, use the **Admin Access** workspace to grant yourself the necessary access. Isso garante que você tenha direitos administrativos e acesso de usuário aos produtos da Experience Platform. For detailed steps on how to set up initial access, see the [admin access instructions](../setup/starter-admin-access.md).
...
Now that you have administrator privileges, you can assign roles and permissions to yourself and other users in your organization. Esta etapa é necessária antes de acessar o Real-Time CDP Collaboration ou permitir que outros possam usá-lo. Para obter instruções detalhadas, consulte [como configurar permissões](../setup/starter-permission-controls.md). For more information about the different roles and permissions available in Collaboration, see the [manage roles](../permissions/manage-roles.md) documentation.
