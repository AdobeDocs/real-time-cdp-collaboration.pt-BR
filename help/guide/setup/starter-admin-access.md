...
![espaço de trabalho do Admin Console com o produto Adobe Experience Platform realçado.](../../assets/setup/starter/admin-access/admin-console-workspace.png){zoomable="yes"}
...
![Painel de produtos do Adobe Experience Platform com a guia Administradores e a opção Adicionar administrador realçada.](../../assets/setup/starter/admin-access/add-admin.png){zoomable="yes"}
...
![A caixa de diálogo Adicionar administradores de produto exibe as informações da sua conta e a opção Salvar está realçada.](../../assets/setup/starter/admin-access/add-product-admin.png){zoomable="yes"}
...
![Painel de produtos do Adobe Experience Platform com a guia Usuários e a opção Adicionar usuários realçada.](../../assets/setup/starter/admin-access/add-user.png){zoomable="yes"}
...
![A caixa de diálogo Adicionar usuários a este produto exibirá as informações da sua conta e a opção Produtos será realçada.](../../assets/setup/starter/admin-access/add-users-to-product.png){zoomable="yes"}

Em seguida, selecione o ícone adicionar ![Ícone adicionar](../../assets/icons/plus.png) em **[!UICONTROL Produtos]**.
...
![A caixa de diálogo Selecionar perfis de produtos exibe os perfis de produtos selecionados e a opção Aplicar realçada.](../../assets/setup/starter/admin-access/select-product-profiles.png){zoomable="yes"}
