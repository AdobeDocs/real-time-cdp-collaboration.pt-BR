...
* Configurar {#setup}
   ...
   * Configuração inicial do Real-Time CDP Collaboration {#starter-setup}
      * {hide-from-toc}[Configurar acesso de administrador](./setup/starter-admin-access.md)
      * {hide-from-toc}[Configurar controles de permissão](./setup/starter-permission-controls.md)
      * {hide-from-toc}[Uso e consumo de crédito](./setup/starter-credit-usage.md)
* Estabelecer conexões {#connect}
   * [Visão geral.md](./connect/overview.md)
