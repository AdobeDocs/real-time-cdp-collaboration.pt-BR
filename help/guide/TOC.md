...
* Configurar {#setup}
  ...
  * {hide-from-toc}[Visão geral dos públicos-alvo](./setup/audiences-overview.md)
  * Source e gerenciar públicos {#source-audiences}
    * [Visão geral das fontes](./setup/source-overview.md)
    ...
    * [Configurar o armazenamento do Azure para fornecimento de público](./setup/configure-azure-storage-audience-sourcing.md)
    ...
    * [Configurar o Adobe Audience Manager para fornecimento de público](./setup/configure-aam-audience-sourcing.md)
  ...
  * {hide-from-toc}[Passarelas de cruzamento de identidade](./setup/identity-crosswalk.md)
  * [Adicionar e gerenciar dados de medição](./setup/onboard-measurement-data.md)
  * [Gerenciar conexão de dados de medição](./setup/manage-measurement-data-connection.md)
  * [Logs de auditoria](./setup/audit-logs.md)
  * Configuração inicial do Real-Time CDP Collaboration {#starter-setup}
    * [Configurar o acesso do administrador](./setup/starter-admin-access.md)
    * [Configurar controles de permissão](./setup/starter-permission-controls.md)
    * [Uso e consumo de crédito](./setup/starter-credit-usage.md)
* Estabelecer conexões {#connect}
  * [Visão geral](/help/guide/connect/overview.md)
  ...
  * Conexões da plataforma Advertising {#ad-platform-connections}
    * [Visão geral](/help/guide/connect/advertising-platforms/overview.md)
    * [Amazon Marketing Cloud](./connect/advertising-platforms/amc.md)
* Colaborar {#collaborate}
  * [Visão geral](/help/guide/collaborate/overview.md)
...
* Destinos {#destinations}
  ...
  * [Requisitos de destino do armazenamento na nuvem](./destinations/cloud-storage-destination-requirements.md)
  * [Configurar o Adobe Experience Platform como destino](./destinations/experience-platform.md)
...
* Referência {#reference}
  ...
  * {hide-from-toc}[Glossário](./glossary.md)
