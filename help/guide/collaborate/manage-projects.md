...
>abstract="Selecione o nome do anunciante no menu suspenso. As opções são pré-configuradas pelo anunciante nas configurações de conexão para garantir a compatibilidade com sistemas do editor."
